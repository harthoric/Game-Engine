...
public class MousePicker {
	...
	public static float cursorX = 0f;

	public static float cursorY = 0f;

	private DisplayManager dManager;

	public static void setCursorX(float x) {
		cursorX = x;
	}
	...
	private Vector2f getNormalisedDeviceCoordinates(float mouseX, float mouseY) {
		float x = (2.0f * mouseX) / dManager.getWidth() - 1f;
		float y = (2.0f * mouseY) / dManager.getHeight() - 1f;
